import { replaceAt, getBoolPermutations, getPuzzleInput, arraysEqual, countOccurrences, countAllCharacters } from "../../utils";
...
//console.log(input.map(parseLine).reduce((acc, val) => acc + val.length, 0));